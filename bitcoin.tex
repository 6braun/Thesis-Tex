...
Im Folgenden soll die technische Umsetzung dieser Anforderungen am Beispiel von Bitcoin untersucht werden.
...
Im Jahr 1976 stellte \cite{diffie_hellman_1976} die bis dahin unbekannte asymmetrische Verschlüsselung vor, bei der jede Partei ein Schlüsselpaar, bestehend aus privatem und öffentlichem Schlüssel, besitzt. 
...
Das vom Bitcoin-Protokoll verwendete Verfahren wird \emph{Elliptic Curve Cryptography} genannt und bedient sich an den Eigenschaften einer Ellipse. Die im Bitcoin-Protokoll verwendete Ellipse trägt den Namen \emph{secp256k1} \cite[60]{antanopoulos_2014} und hat die, in Abbildung 2.2 vorgestellte, Form:
\begin{figure}[htpb]
	\centering
...
Eine Adresse ist ein aus dem öffentlichen Schlüssel generierter String aus Buchstaben und Zahlen, der Besitzer:innen des Schlüssels zu potentiellen Empfänger:innen einer Transaktion macht. Bei diesem muss es sich allerdings nicht zwangsläufig um eine Person handeln, denn auch Organisationen, geschriebene Skripte, etc. kommen als \emph{abstrakte} Empfänger:innen in Frage \cite[65]{antanopoulos_2014}.
...
\begin{figure}[htpb]
	...
	\caption{Austausch von Adressen nach erfolgreicher Verbindung\\
		Quelle: vgl. \cite[177]{antanopoulos_2014}}
